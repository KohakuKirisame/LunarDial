...
# -------------------------------------------------------
# @By:Kohaku Cao
# @Time:2022-07-01 15:48
# @QQ:1848790911
# @Mail:kohaku@hepnovel.com
# @File:ReminderItemController.py
# @For:月時計 ~Lunar Dial~
# -------------------------------------------------------
...
from View.ReminderItemView import *
from Controller.EditController import *
from Controller.DetailController import *
import time
...
class ReminderItemController(QWidget):
    ...
    def mouseDoubleClickEvent(self, event):
        self.detail=DetailController(id=self.id)
        self.detail.show()
