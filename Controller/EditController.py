...
class EditController(QWidget):
    ...
    def setupContent(self,id=0):
        ...
        if id==0:
            ...
            self.ui.timeEdit.setDateTime(QDateTime().fromSecsSinceEpoch(time))
            self.ui.remindEdit.setDateTime(QDateTime().fromSecsSinceEpoch(remind))
